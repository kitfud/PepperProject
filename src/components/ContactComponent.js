...
class Contact extends Component {
    ...
    componentDidMount(){
        ...
        this.setState({
          ...
          this.id =  setTimeout( ()=> {this.setState({booleanredirect:true})},3000) 
                ...
                <div className="col-12">
                    ...
                    <div className="row row-content">
                        ...
                        <div className="col-12 col-md-6">
                          <h3>Send Us Feedback/App Feature Requests:</h3>
    ...
    <Row className="form-group">
            ...
            <Row className="form-group">
                ...
                <Col md={10}>
                    <Control.text model=".telnum" id="telnum" name="telnum"
                        placeholder="Tel. Number (optional)"
                        className="form-control"
          ...
          if(!this.state.booleanredirect){
            return (
                
                <div className = "container">
                  
                <div style = {align} className = "row">
                <div  className= "col-12" > Thank you for submitting your feedback!</div>
                </div>
                <div style = {alignColor} className = "row">
                <div  className= "col-12" >Redirecting to Home Page.....</div>
                </div>
